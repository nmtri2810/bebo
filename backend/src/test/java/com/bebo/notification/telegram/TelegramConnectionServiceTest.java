...
class TelegramConnectionServiceTest {
  ...
  void setUp() {
    ...
    service = new TelegramConnectionService(channelRepository, tokenService, properties);
  }
  ...
  void completeConnectionConnectsChannelWhenTokenIsValid() {
    ...
    when(channelRepository.findByChannelTypeAndConnectTokenHash(
            ChannelType.TELEGRAM, "token-hash"))
